...
function About() {
  return (
    <div className="profile">
      ...
      <h1 className="profile-text">Hi, I am Kumar Satyarth</h1>
      ...
      <div className="profile-links">
        <a href="https://github.com/KumarSatyarth" target='_blank' rel="noreferrer">
          <FaGithub />
        </a>
        <a href="https://www.instagram.com/satyarthsingh_5927/" target='_blank' rel="noreferrer">
          <FaInstagram />
        </a>
        <a href="https://www.linkedin.com/in/kumar-satyarth/" target='_blank' rel="noreferrer">
          <FaLinkedin />
        </a>
